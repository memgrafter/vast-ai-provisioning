#!/usr/bin/env bash
# Launch/check the Carnice/Qwen3.6 27B NVFP4 MTP3 vLLM performance profile on Vast RTX PRO 6000 WS.
#
# Common usage:
#   scripts/launch_carnice_27b_nvfp4_pro6000ws_256k_mtp3.sh --check-only --top 5
#   scripts/launch_carnice_27b_nvfp4_pro6000ws_256k_mtp3.sh
#   scripts/launch_carnice_27b_nvfp4_pro6000ws_256k_mtp3.sh --yes
...
PROFILE="config/launch-profiles/carnice-v2-27b-nvfp4-text-mtp.pro6000ws-performance-256k-mtp3.on-demand.json"

usage() {
  cat <<'EOF'
Usage: scripts/launch_carnice_27b_nvfp4_pro6000ws_256k_mtp3.sh [wrapper-options] [-- select_and_launch.py options]
...
Profile:
  config/launch-profiles/carnice-v2-27b-nvfp4-text-mtp.pro6000ws-performance-256k-mtp3.on-demand.json
...
Examples:
  scripts/launch_carnice_27b_nvfp4_pro6000ws_256k_mtp3.sh --check-only --top 5
  scripts/launch_carnice_27b_nvfp4_pro6000ws_256k_mtp3.sh
  scripts/launch_carnice_27b_nvfp4_pro6000ws_256k_mtp3.sh --yes --monitor-timeout 1800
EOF
}
