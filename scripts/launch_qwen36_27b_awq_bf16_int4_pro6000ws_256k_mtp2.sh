#!/usr/bin/env bash
# Launch/check the cyankiwi Qwen3.6 27B AWQ BF16 INT4 MTP2 vLLM profile on Vast RTX PRO 6000 WS.
#
# Common usage:
#   scripts/launch_qwen36_27b_awq_bf16_int4_pro6000ws_256k_mtp2.sh --check-only --top 5
#   scripts/launch_qwen36_27b_awq_bf16_int4_pro6000ws_256k_mtp2.sh
#   scripts/launch_qwen36_27b_awq_bf16_int4_pro6000ws_256k_mtp2.sh --yes
...
PROFILE="config/launch-profiles/qwen3.6-27b-awq.pro6000ws-performance-256k-mtp2.on-demand.json"

usage() {
  cat <<'EOF'
Usage: scripts/launch_qwen36_27b_awq_bf16_int4_pro6000ws_256k_mtp2.sh [wrapper-options] [-- select_and_launch.py options]
...
Profile:
  config/launch-profiles/qwen3.6-27b-awq.pro6000ws-performance-256k-mtp2.on-demand.json
...
Examples:
  scripts/launch_qwen36_27b_awq_bf16_int4_pro6000ws_256k_mtp2.sh --check-only --top 5
  scripts/launch_qwen36_27b_awq_bf16_int4_pro6000ws_256k_mtp2.sh
  scripts/launch_qwen36_27b_awq_bf16_int4_pro6000ws_256k_mtp2.sh --yes --monitor-timeout 1800
EOF
}
