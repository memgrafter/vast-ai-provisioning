...
#
# Common usage:
#   scripts/launch_qwen36_35b_a3b_awq_2x3090_160k_bf16kv_mtp2_c8.sh --check-only --top 3
#   scripts/launch_qwen36_35b_a3b_awq_2x3090_160k_bf16kv_mtp2_c8.sh
#   scripts/launch_qwen36_35b_a3b_awq_2x3090_160k_bf16kv_mtp2_c8.sh --yes
#
...
usage() {
  cat <<'EOF'
Usage: scripts/launch_qwen36_35b_a3b_awq_2x3090_160k_bf16kv_mtp2_c8.sh [wrapper-options] [-- select_and_launch.py options]
...
Examples:
  scripts/launch_qwen36_35b_a3b_awq_2x3090_160k_bf16kv_mtp2_c8.sh --check-only --top 3
  scripts/launch_qwen36_35b_a3b_awq_2x3090_160k_bf16kv_mtp2_c8.sh --check-only --relax-policy '{"storage":{"min_disk_bw":300}}'
  scripts/launch_qwen36_35b_a3b_awq_2x3090_160k_bf16kv_mtp2_c8.sh
  scripts/launch_qwen36_35b_a3b_awq_2x3090_160k_bf16kv_mtp2_c8.sh --yes --monitor-timeout 2400
EOF
}
