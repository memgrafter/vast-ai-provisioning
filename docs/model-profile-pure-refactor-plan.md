...
- [ ] │   └── templates
- [ ] ├── docs
- [ ] │   ├── model-profile-pure-refactor-plan.md
- [ ] │   └── model-profile-refactor-plan.md
- [ ] ├── env.modeltransfer
- [ ] ├── env.modeltransfer.example
- [ ] ├── env.vast-management
- [ ] ├── env.vast-management.example
- [ ] ├── instances
- [ ] │   ├── 36169536.current.json
- [ ] │   ├── 36169536.json
- [ ] │   ├── 36170074.current.json
- [ ] │   ├── 36170074.json
- [ ] │   ├── 36170840.current.json
- [ ] │   ├── 36170840.json
- [ ] │   ├── 36171204.current.json
- [ ] │   ├── 36171204.json
- [ ] │   ├── 36171537.current.json
- [ ] │   ├── 36171537.json
- [ ] │   ├── 36171537.logs.tail1000.txt
- [ ] │   ├── 36171537.logs.tail200.txt
- [ ] │   ├── 36171537.monitor.current.json
- [ ] │   ├── 36171537.monitor.logs.txt
- [ ] │   ├── 36172532.json
- [ ] │   ├── 36172532.monitor.current.json
- [ ] │   ├── 36172532.monitor.logs.txt
- [ ] │   ├── 36172813.json
- [ ] │   ├── 36172813.monitor.current.json
- [ ] │   ├── 36172813.monitor.logs.txt
- [ ] │   ├── 36173013.json
- [ ] │   ├── 36173013.monitor.current.json
- [ ] │   ├── 36173013.monitor.logs.txt
- [ ] │   ├── 36173210.json
- [ ] │   ├── 36173210.monitor.current.json
- [ ] │   ├── 36173210.monitor.logs.txt
- [ ] │   ├── 36173523.json
- [ ] │   ├── 36173523.monitor.current.json
- [ ] │   ├── 36173523.monitor.logs.txt
- [ ] │   ├── 36173574.json
- [ ] │   ├── 36173574.monitor.current.json
- [ ] │   ├── 36173574.monitor.logs.txt
- [ ] │   ├── 36173642.json
- [ ] │   ├── 36173642.monitor.current.json
- [ ] │   ├── 36173642.monitor.logs.txt
- [ ] │   ├── 36173759.json
- [ ] │   ├── 36173759.monitor.current.json
- [ ] │   ├── 36173759.monitor.logs.txt
- [ ] │   ├── 36174371.json
- [ ] │   ├── 36174371.monitor.current.json
- [ ] │   ├── 36174371.monitor.logs.txt
- [ ] │   ├── 36174533.json
- [ ] │   ├── 36174533.monitor.current.json
- [ ] │   ├── 36174533.monitor.logs.txt
- [ ] │   ├── 36175018.json
- [ ] │   ├── 36175018.monitor.current.json
- [ ] │   └── 36175018.monitor.logs.txt
- [ ] ├── models
- [ ] │   └── cyankiwi
- [ ] ├── offers
- [ ] │   ├── 22589934.selected.json
- [ ] │   ├── 27594208.selected.json
- [ ] │   ├── 29784088.selected.json
- [ ] │   ├── 32304370.selected.json
- [ ] │   ├── 32730145.selected.json
- [ ] │   ├── 32859811.selected.json
- [ ] │   ├── 34230042.selected.json
- [ ] │   ├── 34871310.selected.json
- [ ] │   ├── 34871313.storage40.json
- [ ] │   ├── 35514379.selected.json
- [ ] │   ├── 35740192.selected.json
- [ ] │   ├── 35846868.selected.json
- [ ] │   ├── 35846873.selected.json
- [ ] │   ├── 36057556.selected.json
- [ ] │   └── 36072186.selected.json
...
- [ ] ├── scripts
- [ ] │   ├── __pycache__
- [ ] │   ├── apply_vast_template.py
- [ ] │   ├── build_vast_template.py
- [ ] │   ├── monitor_instance_readiness.py
- [ ] │   └── select_and_launch.py
- [ ] ├── state
- [ ] │   ├── current-infra.json
- [ ] │   ├── last-create-result.json
- [ ] │   ├── launch-round-2.log
- [ ] │   ├── launch-round-2.pid
- [ ] │   ├── launch-round-3.log
- [ ] │   ├── launch-round-3.pid
...
- [ ] ├── templates
- [ ] │   ├── my_templates.json
- [ ] │   ├── update_template_auth_result.json
- [ ] │   ├── update_template_result.json
- [ ] │   ├── vastai_vllm_templates.json
- [ ] │   ├── vLLM_R2_Model_20260504.21483c1ed2cf1c2d8f551d0a093d783a.json
- [ ] │   ├── vLLM_R2_Model_20260504.b174caeb667a9c8e5cd7a68bd8b8af2e.20260505T094519Z.json
- [ ] │   └── vLLM_R2_Model_20260504.current.json
- [ ] ├── test.sh
- [ ] ├── tests
- [ ] │   ├── integration
- [ ] │   ├── pyproject.toml
...
- [ ] ├── VAST_FAST_START_TERMINATION_PLAN.md
- [ ] ├── VAST_SDK_AUTOMATION_PLAN.md
- [ ] └── VAST_VLLM_TEMPLATE_PLAN.md
- [ ]
